...
cargobay.toggle = function(window, undefined) {
    ...
    var init, _addMultiEventistener, toggle, _show, _hide, _hideFast;
    ...
    _show = function(btn, target, targetContent, height) {
        cargobay.general.animate(target, 'height', 'px', height, 'auto', animationDuration);
    ...
    _hide = function(btn, target, targetContent, height) {
        cargobay.general.animate(target, 'height', 'px', 0, height, animationDuration);
