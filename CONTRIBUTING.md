...
Pull request are the best way to provide a bug fix or to propose enhancements to cargobay. This guide will show you how to get started.

## Step 1: Setup your environment

Before working on the cargobay, setup an environment with `bundler`, `gulp`and `npm`.
...
Start by forking the [repository](https://github.com/Kunstmaan/cargobay.git). Clone it to your computer and then you just need to add the upstream repository as a remote.

```
git remote add upstream https://github.com/Kunstmaan/cargobay.git
```
...
The title of your pull request should always start with the component you modified ([cbAudioplayer], [cbToggle], ...). Use a verb (fixed ..., added ..., ...) to start the title and don't add a period at the end. Try to keep it brief but comprehensive.
...
* Make sure you also update [the Generator bundle](https://github.com/Kunstmaan/KunstmaanBundlesCMS/tree/master/src/Kunstmaan/GeneratorBundle) if needed
...
You can now make a pull request on the `Kunstmaan/cargobay` GitHub repository.
...
| Generator PRs | comma separated list of PRs in the Generator bundle
```
